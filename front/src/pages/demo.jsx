      ...
      <div style={{ backgroundColor: "#f9f3ef" }}>
        ...
        <section className="sectionMainContact">
          <div className="title-main-contact">
            <h2>
              Would you like to enter a world of innovation that will help your
              business to grow?
            </h2>
          </div>
        ...
        <section className="section-2-demo">
          <h2>
            ...
            top UX/UI solutions and product, service and brand experiences.
          </h2>
          <div>
            {isMobile() ? (
            ...
            <div className="item-3-1-flex">
              ...
              <div>
                ...
                <p>
                  ...
                  needs your users are. How is the UX/UI experience for your
                  customers?
                </p>
              </div>
            </div>
