      ...
      <div style={{ backgroundColor: "#f9f3ef" }}>
        ...
        <section className="section-1-demo">
          <h1>
            ...
            <br /> design studio that integrates
            <br /> Intuitive Marketing and Design
            {isMobile && <br />} Thinking for your Brand.
          </h1>
          <Link to={"/calendar"}>SCHEDULE A DEMO</Link>
        ...
        <section className="sectionMainContact">
          <div className="title-main-contact">
            <h2>
              Would you like to discover a world of branding that will help your
              business grow?
            </h2>
          </div>
        ...
        <section className="section-2-demo">
          <h2>
            ...
            solutions and product, service and brand/branding experiences.
          </h2>
          <div>
            {isMobile() ? (
            ...
            <div className="item-3-1-flex">
              ...
              <div>
                ...
                <p>
                  ...
                  needs of your users are for your branding.
                </p>
              </div>
            </div>
          </div>
